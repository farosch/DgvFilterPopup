...
namespace DgvFilterPopup {
    ...
    public class DgvBaseColumnFilter : UserControl {
        ...
        public void Init(DgvFilterManager FilterManager, DgvBaseFilterHost FilterHost, DataGridViewColumn gridColumn,DataView boundDataView){
            ...
            mFilterHost = FilterHost;
            mDataGridViewColumn = gridColumn;
            mBoundDataView = boundDataView;
            mOriginalDataGridViewColumnHeaderText = gridColumn.HeaderText;
            if (gridColumn.DataPropertyName != "")
                mColumnDataType = boundDataView.Table.Columns[gridColumn.DataPropertyName].DataType;
            else
                mColumnDataType = typeof(string);
